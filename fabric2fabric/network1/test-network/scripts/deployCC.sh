...
if [ "$CC_SRC_PATH" = "NA" ]; then
	...
	elif [ "$CC_NAME" = "crossprimary" ]; then
		echo $'\e[0;32m'crossprimary$'\e[0m' chaincode
		CC_SRC_PATH="../mychannel/crossprimary"
	elif [ "$CC_NAME" = "verifyregistry" ]; then
		echo $'\e[0;32m'verifyregistry$'\e[0m' chaincode
		CC_SRC_PATH="../mychannel/verifyregistry"
	elif [ "$CC_NAME" = "verifynetwork2" ]; then
		echo $'\e[0;32m'verifyregistry$'\e[0m' chaincode
		CC_SRC_PATH="../mychannel/verifynetwork2"
	elif [ "$CC_NAME" = "verifynetwork3" ]; then
		echo $'\e[0;32m'verifyregistry$'\e[0m' chaincode
		CC_SRC_PATH="../mychannel/verifynetwork3"
	else
