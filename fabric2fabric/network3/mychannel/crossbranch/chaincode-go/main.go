...
import (
	"fmt"
	"github.com/crossmesh/crossmesh-samples/network3/crossbranch/chaincode"
...
func main() {
	...
	contract.Name = "crossmesh.network3.crossbranch"
	...
	cc.Info.Title = "Network3CrossBranchChaincode"
